...
class Server:
    ...
    def __init__(self):
        ...
        def login_response():
            ...
            path = self.plugin_selection(self.available_plugins)
            ...
            #Generating and preparing the token for message to client
            ...
            instance = self.rlm.get_plugin(plugin_id)
            ...
            base_command["token"] = generated_token
            self.dm.save_data("commands", base_command)
        ...
        def command_confirmation(token: str):
            ...
            if self.tm.check_token_authenticity(token):
                ...
                #Gets the last command from MongoDB
                ...
                #Otherwiese a new command is generated by the system
                    ...
                    db_file = command
                    db_file["token"] = token
                    self.dm.save_data("commands", db_file)
    ...
    def plugin_selection(self, plugin_selection: dict):
